        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building efficient, scalable software solutions with expertise in multiple programming languages and frameworks.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CLOUD & DATA</h3>
              <h4>Cloud Computing & Data Engineering</h4>
              <p>
                AWS certified professional with experience in data engineering and cloud infrastructure management.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
